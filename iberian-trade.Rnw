...
changepoint_dates_found <- data.frame(
  Method = c("All links, cpt.meanvar (+filtered)", "All links, Lanzante/Pettitt", "All links, Lanzante/Pettitt (filtered)", "Internal links, cpt.mean (+filtered)", "Multi-sequence, e.divisive (+filtered)"),
