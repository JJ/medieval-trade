...
\item[Research question 1] Is there a changepoint in the Iberian peninsula trade links? Is it connected to the Danubian hypothesis?
\item[Research question 2] If that is the case, can we find a local cause for this changepoint that is concomitant or caused by the Danubian hypothesis?
\end{itemize}
