...
library(changepoint)
all_links_changepoint <- cpt.meanvar(all_iberian_links_decade$n, test.stat="Normal", penalty="BIC")
...
After we have established the validity of the dataset, we will go ahead and try and answer the first research question.
