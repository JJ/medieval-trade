...
<<trade.link.evolution, echo=F, message=F, warning=F, fig.cap="Evolution through time of the number of links with the main trading partners of the Iberian Peninsula.", fig.height=4>>=
library(purrr)
