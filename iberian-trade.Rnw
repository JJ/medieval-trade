...
<<trade.plot, echo=FALSE, fig.cap="Time series of interior and all trade link density for the Iberian Peninsula", fig.height=4>>=
library(ggplot2)
library(ggthemes)
