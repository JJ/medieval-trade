...
<<trade.overview, echo=FALSE, fig.height=4, fig.cap="MDS plot of the regional network using (current) regions as nodes", message=FALSE>>=
library(igraph)
...
plot(regional_graph, vertex.size=2, vertex.label.cex=0.6, edge.arrow.size=0.2,
     ...
     main="Regional trade links in the Iberian Peninsula")
@
