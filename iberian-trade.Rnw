...
library(pals)
links_graph <- ggplot() + geom_line( data=regional_links_summary[regional_links_summary$trade_link == "Iberian Peninsula - Britannia",],aes(x=decade, y=links, color="UK"))+
  geom_point( data=regional_links_summary[regional_links_summary$trade_link == "Iberian Peninsula - Britannia",],aes(x=decade, y=links, color="UK")) +
...
top_partner_links <- c("Iberian Peninsula - Britannia",
