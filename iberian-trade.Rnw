...
<<trade.link.evolution.relative, echo=F, message=F, warning=F, fig.cap="Evolution through time of the link density with the main trading partners of the Iberian Peninsula.The red dashed line indicates the computed changeopoint.", fig.height=5>>=
