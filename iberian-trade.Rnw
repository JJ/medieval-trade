...
We are explicitly working in a complex network and using complex network analysis to understand the dynamics behind the data and the historical events that occurred at the same time.
