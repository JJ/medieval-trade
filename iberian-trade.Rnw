...
\item\edit{{\em \rev{Q}uestion 2}: Is there a specific change in the network that can explain that changepoint?}
\item{\em \rev{Q}uestion \edit{3}}: \edit{If that is the case, can that change in the network be explained by known historically established factors or events?}
\item\edit{{\em \rev{Q}uestion 4}: Working in the other causal direction, would this be a new factor that would explain the fall of the Roman Empire and thus the end of Antiquity and the beginning of the Middle Ages?}
\end{itemize}
