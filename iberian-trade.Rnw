...
We are going to focus in this paper on the Iberian Peninsula. As a peripheral part of the Roman empire any disruption might have affected it, but in a different way or in a different time frame. This is why we are specially interested in works that focus on this area, like [@fernandez2017aristocrats].
